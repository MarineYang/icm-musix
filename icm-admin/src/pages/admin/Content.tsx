                  ...
                  <DialogContent className="max-w-2xl">
                    ...
                    <form onSubmit={handleSaveNotice} className="space-y-4">
                      <div>
                        ...
                        <Input id="title" name="title" defaultValue={editingNotice?.title} required />
                      </div>
                      <div>
                        <Label htmlFor="content">내용 (HTML 지원)</Label>
                        <Textarea id="content" name="content" defaultValue={editingNotice?.content} rows={10} required />
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2">
                          <Switch id="is_active" name="is_active" defaultChecked={editingNotice?.is_active ?? true} />
